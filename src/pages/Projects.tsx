...
const Projects = () => {
	...
	const projects = [
		...
		},
		{
			...
			description:
				"A collaborative project management tool built with Next.js and real-time features using WebSockets.",
			image: "/placeholder.svg",
		...
		},
		{
			...
			title: "AI Chat Bot",
			description:
				"Natural language processing chatbot built with Python and integrated with multiple messaging platforms.",
			image: "/placeholder.svg",
		...
		},
		{
			...
			description:
				"Cross-platform mobile application with real-time weather data and location-based forecasts.",
			image: "/placeholder.svg",
		...
		},
		{
			...
			description:
				"Interactive dashboard for data analysis with charts, filters, and real-time updates.",
			image: "/placeholder.svg",
		...
		},
		{
			...
			description:
				"Scalable microservices system with Docker, Kubernetes, and monitoring solutions.",
			image: "/placeholder.svg",
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						<p className="text-gray-400 text-lg max-w-2xl mx-auto">
							A showcase of my work in web development, mobile apps, and
