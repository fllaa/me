...
import { Calendar, MapPin, Award, Code, Database, Cloud, Smartphone, Briefcase } from 'lucide-react';
...
const About = () => {
  const skills = {
    ...
    Cloud: ['AWS', 'Docker', 'Kubernetes', 'Vercel', 'Netlify', 'GitHub Actions'],
  ...
  const experience = [
    {
      ...
      description: 'Leading a team of 5 developers in building scalable web applications. Implemented micro-frontend architecture and improved performance by 40%.',
      achievements: [
    ...
    },
    {
      ...
      period: '2020 - 2022',
      location: 'Remote',
      description: 'Developed end-to-end features for a SaaS platform serving 50K+ users. Built REST APIs and implemented real-time features.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Contributed to client projects ranging from e-commerce to corporate websites. Focused on responsive design and performance optimization.',
      achievements: [
              ...
              <section>
                ...
                <div className="space-y-6">
                  {experience.map((job, index) => (
                    <GlassCard key={index} className="hover:bg-white/15 transition-all duration-300">
